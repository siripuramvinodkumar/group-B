...
import { getShoutouts, updateUser } from '../../backend/api';
import ShoutoutCard from '../components/ShoutoutCard';
import { Calendar, Mail, Building, Award, Send, Users, Edit3, Save } from 'lucide-react';
...
const Profile: React.FC<ProfileProps> = ({ user }) => {
  ...
  const handleUpdate = async () => {
    await updateUser({ ...user, name: editName, department: editDept });
    setIsEditing(false);
